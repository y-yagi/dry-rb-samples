...
puts user_rule.call(user: { age: 19 }).inspect
puts user_rule.call(user: { age: 18 }).inspect
puts user_rule.call(user: { age: 'seventeen' }).inspect
puts user_rule.call(user: { }).inspect
